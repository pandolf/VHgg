...
#ifndef RedNtpFinalizer_THq_h
#define RedNtpFinalizer_THq_h
...
class RedNtpFinalizer_THq : public RedNtpFinalizer {
...
public :
   ...
   //RedNtpFinalizer_THq(TTree *tree=0);
   RedNtpFinalizer_THq( const std::string& dataset, const std::string& selectionType, const std::string& bTaggerType="JP" );
   virtual ~RedNtpFinalizer_THq();
