...
std::string getSingleFileName( const std::string& redntpVersion, const std::string& dataset, const std::string& selectionType, const std::string& bTaggerType ) {
  ...
  if(!use_inverted_photID){
    fileName = "finalizedTrees_" + redntpVersion + "/THq_" + dataset + "_" + selectionType + "_" + bTaggerType + ".root";
  }else{
    fileName = "finalizedTrees_" + redntpVersion + "/THq_" + dataset + "_" + selectionType + "_invertedPhotID_" + bTaggerType + ".root";
  }
  return fileName;
